...
class Senary:
    def __init__(self):
        self.file = open('bd\\level1.txt','r')
        self.imgStone = pygame.image.load('img\\stone.png')
        self.imgInimigo = pygame.image.load('img\\inimigo1.png')
        self.imgInimigo2 = pygame.image.load('img\\inimigo2.png')
        self.imgLife = pygame.image.load('img\\rapadura.png')
